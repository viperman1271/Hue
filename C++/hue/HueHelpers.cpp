...
bool HueHelpers::FillSceneInformation(HueBridge* bridge, HueSceneInformation** sceneDay, HueSceneInformation** sceneNight)
{
...
std::string HueHelpers::replace(std::string &s, const std::string &toReplace, const std::string &replaceWith)
{
	return(s.replace(s.find(toReplace), toReplace.length(), replaceWith));
}

void HueHelpers::SwitchScene(HueBridge* bridge, HueRuleInformation rule, HueSceneInformation* originalScene, HueSceneInformation* newScene)
{
